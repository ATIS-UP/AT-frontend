...
export function AppShell() {
  ...
  const getViewTitle = () => {
    ...
    if (location.pathname.includes('/admin')) return { title: 'Administración', subtitle: 'Usuarios y Permisos' };
  ...
  return (
    <div className="min-h-screen bg-brand-background flex">
      ...
      >
        ...
        <footer className="app-main-content px-4 md:px-10 py-6 border-t border-slate-100/60 bg-white/50 text-center pb-20 lg:pb-6 transition-[margin] duration-150">
